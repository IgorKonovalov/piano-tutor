...
| [0010](0010-alignment-ends-where-the-player-stopped-an-unplayed-tail-is-free.md) | Alignment ends where the player stopped: an unplayed tail is free | accepted 2026-09-11 |
...
| [0018](0018-the-timeline-carries-the-marks-on-the-page.md) | The timeline carries the marks on the page, as OSMD reads them | proposed |
...
| [0022](0022-the-per-phase-gate-is-the-fast-gate-and-the-end-to-end-suite-is-owed-once-per-plan.md) | The per-phase gate is the fast gate, and the end-to-end suite is owed once per plan | accepted 2026-09-12 |
